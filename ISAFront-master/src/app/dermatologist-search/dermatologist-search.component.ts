...
@Component({
  selector: 'app-dermatologist-search',
  templateUrl: './dermatologist-search.component.html',
  styleUrls: ['./dermatologist-search.component.css'],
  animations: [
...
export class DermatologistSearchComponent implements OnInit {
  ...
  getDoctors() {
    this.service.getAllDoctorsDerm().subscribe(
      data => {
        this.doctors = data;
        console.log(data[0])
